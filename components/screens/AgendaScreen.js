        ...
        <AppContainer navigation={props.navigation}>
            <ScrollView>
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{flex: 1}} onPress={() => carouselRef.current.snapToItem(0)}>
                        <Text style={{
                            flex: 1,
                            textAlign: 'center',
                            fontSize: 12,
                    ...
                    <TouchableOpacity style={{flex: 1}} onPress={() => carouselRef.current.snapToItem(1)}>
                        <Text style={{
                            flex: 1,
                            textAlign: 'center',
                ...
                <Carousel
                    ...
                    renderItem={(item) => {
                        ...
                        if(item.index === 0) {
                            return (
                                <ScrollView contentContainerStyle={{marginHorizontal: 36, marginTop: 25}}>
                                    <View>
                                        <View style={{flexDirection: 'row'}}>
                                            <Text style={{width: 70, fontFamily: 'Montserrat-Regular', fontSize: 12}}>
                                                Time
                                            </Text>
                                        ...
                                        <Text style={{fontFamily: 'Montserrat-Bold', textAlign: 'center', marginTop: 20}}>None
                                            Of Your Data{'\n'}at this time</Text>
                                    </View>
                                </ScrollView>
                            )
