    ...
    return (
        <AppContainer navigation={props.navigation}>
            <ScrollView>
                        ...
                        <ScrollView>
                            {
                                ...
                                <View style={{flex: 1}}>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => {
                                        ...
                                        <Text style={{backgroundColor: 'blue', color: 'white', alignSelf: 'flex-end', marginRight: 15, paddingHorizontal: 32, paddingVertical: 15, borderRadius: 10, fontFamily: 'Montserrat-Regular', marginTop: 30}}>
                                            OK
                                        </Text>
                ...
                <View style={{flexDirection: 'row', marginTop: 15, marginHorizontal: 15}}>
                    <View style={{flex: 1}}>
                        ...
                        <Text style={{
                            color: 'blue',
                            fontFamily: "Montserrat-Regular"
                        }}>{selectedStartDate ? moment(selectedStartDate).format('DD MMM YYYY') : moment().format('DD MMM YYYY')} {selectedEndDate && ` - ${moment(selectedEndDate).format('DD MMM YYYY')}`}</Text>
                    </View>
                ...
                <Text style={{fontFamily: 'Montserrat-Bold', marginHorizontal: 15, marginVertical: 20}}>Summary</Text>

                <View style={{marginHorizontal: 15, marginTop: 15, backgroundColor: '#f3f3f3', paddingHorizontal: 15, paddingVertical: 20, borderRadius: 8}}>
                    <Text style={{fontFamily: 'Montserrat-Regular', fontSize: 12, marginBottom: 7}}>
                        Passed
                    </Text>
