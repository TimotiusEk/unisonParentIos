...
export default function OnlineTestScreen(props) {
  const [multipleChoices, setMultipleChoices] = useState([
    ...
    {
      question:
        'Planet luar adalah planet yang jarak rata-rata ke Matahari-nya lebih panjang dibandingkan jarak rata-rata Bumi-Matahari. Nah, planet inilah yang disebut planet luar. Mars, Jupiter, Saturnus, Uranus, dan Neptunus termasuk planet luar.\n' +
        '\n' +
  ...
  const [essays, setEssays] = useState([
    {
      question:
        'Jelaskan tentang objek material geografi beserta fenomena di tiap lapisannya!',
    },
