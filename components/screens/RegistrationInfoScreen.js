    ...
    return (
        <KeyboardAwareScrollView
            ...
            <View style={{flex: 1, backgroundColor: 'white', paddingBottom: 20}}>
                ...
                <View style={{paddingHorizontal: 36, marginTop: 15}}>
                    <TextInputLayout
                ...
                <View style={{paddingTop: 50, paddingLeft: 20, flexDirection: 'row', alignItems: 'flex-end'}}>
                    <Image source={require('../../assets/images/logo_one_line.png')}
                           style={{ height: 74 / 2.3, width: 239 / 2.3, resizeMode: 'contain'}}/>
                </View>
            </View>
        </KeyboardAwareScrollView>
    )
